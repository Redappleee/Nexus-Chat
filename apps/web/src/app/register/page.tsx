    ...
    <div className="flex min-h-screen items-center justify-center bg-[#080c16] p-6 text-zinc-100">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-2xl font-extrabold text-zinc-100 tracking-tight">Create your account</h1>
          <p className="mt-1.5 text-xs text-zinc-400">Join Nexus Chat in seconds</p>
        </div>
